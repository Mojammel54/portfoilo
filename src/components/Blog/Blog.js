                    ...
                    <div className="relative group">
                        ...
                        <button className="relative px-7 py-4 bg-black rounded-lg leading-none lg:flex items-center lg:divide-x divide-gray-600">
                            <span className="lg:flex items-centerspace-x-5">
                                <span className="lg:block hidden pr-8 text-gray-100">BLOG</span>
                            </span>
                            <span className="pl-6 text-indigo-400 group-hover:text-gray-100 transition duration-200 text-xl font-semibold"> <span className='lg:hidden'>BLOG<br /></span> <span className='lg:hidden '>..................................................................... <br /> </span>Coming soon....</span>
                        </button>
                    </div>
                </div>
            </div>
